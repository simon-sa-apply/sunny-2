...
from app.core.cache import get_cached_model, set_cached_model
from app.core.metrics import log_solar_request
from app.repositories.cache_repository import cache_repository
from app.services.copernicus import SolarRadiationData, copernicus_service
from app.services.pvgis import PVGISRadiationData, pvgis_service
...
class UnifiedSolarData:
    ...
    timestamps: list[datetime] | None = None  # Hourly (CAMS)
    monthly_ghi: dict[str, float] | None = None  # Monthly (PVGIS/CAMS)
...
class SolarDataService:
    ...
    async def _try_pvgis(
        ...
        lon: float,
        year: int,
        fallback_data: SolarRadiationData | None = None,
    ) -> UnifiedSolarData:
